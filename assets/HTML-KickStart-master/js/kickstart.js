...
jQuery(document).ready(function($){
	...
	// tab setup
    	...
    	var selected_tab =  $("#current_tab").val();
	
		if( selected_tab != '' && selected_tab != '#tabr1' )
		{ 
			$('.tab-content').addClass('clearfix').not(selected_tab).hide();	
			
			var  first_tab = $('ul.tabs').find('li:first');  
			var tabs = first_tab.nextAll("li");
